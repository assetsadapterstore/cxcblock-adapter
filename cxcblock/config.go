...
var (
	MainNetAddressPrefix = cxcTransaction.BTCMainnetAddressPrefix
	TestNetAddressPrefix = cxcTransaction.BTCTestnetAddressPrefix
)
...
type WalletConfig struct {
	...
	OmniSupport bool
	//主网地址前缀
	MainNetAddressPrefix cxcTransaction.AddressPrefix
	//测试网地址前缀
	TestNetAddressPrefix cxcTransaction.AddressPrefix
	//小数位精度
	Decimals int32
	//最低手续费
