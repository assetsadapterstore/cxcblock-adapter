...
func TestGetBlockHash(t *testing.T) {
	...
	hash, err := tw.GetBlockHash(46250)
	if err != nil {
...
func TestGetBlock(t *testing.T) {
	raw, err := tw.GetBlock("0038698b34bdf270204adc7345383965682cd82742ea2a8e839b94ef16c40751")
	if err != nil {
...
func TestGetBlockByHeight(t *testing.T) {
	raw, err := tw.GetBlockByHeight(11111)
	if err != nil {
		t.Errorf("GetBlockByHeight failed unexpected error: %v\n", err)
		return
	}
	t.Logf("GetBlockByHeight = %v \n", raw)
}

func TestGetTransaction(t *testing.T) {
	raw, err := tw.GetTransaction("ec92d019a8f12f495ed44be45ef35429dd43deff41c3cc26be1b361422f15034")
	if err != nil {
